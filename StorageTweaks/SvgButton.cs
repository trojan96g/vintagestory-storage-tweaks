    ...
    : GuiElement(capi, bounds)
{
    ...
    private ImageSurface DrawNormalTexture(int size)
    {
        ...
        api.Gui.DrawSvg(svgAsset, surface, 2, 2, size - 4, size - 4, ColorUtil.ColorFromRgba(233, 221, 206, 255));
    ...
    private ImageSurface DrawHoverTexture(int size)
    {
        ...
        api.Gui.DrawSvg(svgAsset, surface, 2, 2, size - 4, size - 4, ColorUtil.ColorFromRgba(0, 221, 0, 127));
